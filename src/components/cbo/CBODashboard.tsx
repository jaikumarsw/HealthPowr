...
export function CBODashboard() {
  ...
  const [membershipRole, setMembershipRole] = useState<'owner' | 'admin' | 'member' | null>(
    null,
  );
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="max-w-md w-full bg-white border border-gray-200 rounded-2xl p-6 text-center">
          ...
          <p className="text-sm text-gray-600 mt-2">
            This account is not linked to any organization membership yet. If you are staff,
            sign in from the staff portal with your invite code.
          </p>
